...
class LTRTrainer(BaseTrainer):
    ...
    def cycle_dataset(self, loader):
        ...
        loader.dataset.p_datasets = [int(i / min(loader.dataset.p_datasets)) for i in loader.dataset.p_datasets]
        loader.dataset.p_datasets = [j / 150 * self.epoch if idx in night_dataset_indices else j for idx, j in
                                     enumerate(loader.dataset.p_datasets)]
