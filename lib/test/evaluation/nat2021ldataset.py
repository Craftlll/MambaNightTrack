...
class NAT2021LDataset(BaseDataset):
    """ NAT2021L dataset - Long sequences subset (23 sequences).
    
    NAT2021L 是 NAT2021 的长序列子集，包含 23 个较长的夜间跟踪序列。
    适合快速验证模型在长序列上的表现。
